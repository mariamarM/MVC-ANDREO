    ...
    if (isset($_GET['force']) && $_SERVER['REMOTE_ADDR'] === '127.0.0.1') {
        ...
        <style>
            ...
            h5 {
                color: #000;
                text-align: center;
                font-family: "Manrope", sans-serifº;
                font-size: 18px;
                font-style: normal;
                font-weight: 400;
                line-height: 28px;
            ...
            <div class="containerPL">
                ...
                <div class="contenedorlog">
                    ...
                    <div class="btnsLog">
                        ...
                        <a href="<?php echo BASE_URL; ?>register.php" class="btnLogin">Get an account</a>
                    </div>
                </div>
            </div>
        </body>
...
<body class="userdashboard">
    ...
    <main>
        <h1><i class="fas fa-user-circle"></i> Bienvenido, <?= htmlspecialchars($_SESSION['user_name'] ?? 'Usuario') ?>!
        </h1>
                ...
                <div id="reviews-container">
                    ...
                    <?php else: ?>
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: start;">
                                    ...
                                    <div style="margin-left: 15px;">
                                        ...
                                        <a href="<?php echo BASE_URL; ?>views/reviews/update.php?id=<?php echo $review['id']; ?>"
                                            style="color: #ffc107; margin-right: 10px;" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?php echo BASE_URL; ?>views/reviews/delete.php?id=<?php echo $review['id']; ?>"
                                            style="color: #ff6b6b;" onclick="return confirm('¿Eliminar esta review?');"
                                            title="Eliminar">
                        ...
                        <?php if (count($reviews) > 2): ?>
                            <div
                                style="text-align: center; margin-top: 15px; padding: 10px; background: #444; border-radius: 10px;">
            ...
            <form id="createReviewForm" action="<?php echo BASE_URL; ?>views/reviews/create.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="comment" name="comment" placeholder="Escribe tu opinión sobre esta canción..."
