...
$albumName = '';
$albumArtist = '';
$albumCover = ''; // Variable para la portada del álbum
...
if (empty($albumName)) {
    ...
    try {
        ...
        if (empty($albumSongs)) {
            ...
            // 3. OBTENER LA PORTADA DEL ÁLBUM desde la primera canción
            // Si la primera canción tiene portada, usarla
            if (!empty($firstSong['album_cover'])) {
                $albumCover = $firstSong['album_cover'];
            } else {
                // Buscar en todas las canciones del álbum una que tenga portada
                ...
                // Si ninguna canción tiene portada, usar una por defecto
                if (empty($albumCover)) {
            ...
            // 5. OBTENER REVIEWS DEL ÁLBUM desde la tabla reviews
                                    ...
                                    <div class="review-header">
                                        ...
                                        <div class="review-user">
                                            <div class="review-username">
                                                <?php echo htmlspecialchars($review['username'] ?? 'Anonymous'); ?></div>
                                            <div class="review-song">on
                                                "<?php echo htmlspecialchars($review['song_title'] ?? $albumSongs[0]['title'] ?? 'Unknown Song'); ?>"
                                            </div>
                                        </div>
